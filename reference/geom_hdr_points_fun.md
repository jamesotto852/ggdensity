...
Compute the highest density regions (HDRs) of a bivariate pdf and plot
the provided data as a scatterplot with points colored according to
...
geom_hdr_points_fun understands the following aesthetics (required
