...
**ggdensity** is available on CRAN and can be installed with `install.packages("ggdensity")`.
You can also install its development version from [GitHub](https://github.com/) with:
